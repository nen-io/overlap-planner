...
`docs/screenshots/desktop.png` and `mobile.png` are actual Playwright captures of the running, populated application at 1440px and 390px. They are not image-generated mockups. There are no raster/media assets or third-party calls in the app itself. Original authored assets and source follow the repository MIT license; dependency licenses remain with their packages.
